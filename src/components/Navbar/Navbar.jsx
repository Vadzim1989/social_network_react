...
const Navbar = () => {
    return (
        <nav className={c.nav}>
            ...
            <div className={c.item}><NavLink className={navData => navData.isActive ? c.active : c.item} to="/news">News</NavLink></div>
            <div className={c.item}><NavLink className={navData => navData.isActive ? c.active : c.item} to="/music">Music</NavLink></div>
            <div className={c.item}><NavLink className={navData => navData.isActive ? c.active : c.item} to="/users">Users</NavLink></div>
            <div className={c.item}><NavLink className={navData => navData.isActive ? c.active : c.item} to="/settings">Settings</NavLink></div>
        </nav>
    )
}
